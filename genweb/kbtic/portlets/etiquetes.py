...
class Renderer(base.Renderer):
    ...
    render = ViewPageTemplateFile('templates/etiquetes.pt')
...
class AddForm(base.AddForm):
    form_fields = form.Fields(IEtiquetesPortlet)
    label = _(u"Afegeix portlet de etiquetes kbtic")
...
class EditForm(base.EditForm):
    form_fields = form.Fields(IEtiquetesPortlet)
    label = _(u"Edita portlet de etiquetes kbtic")
