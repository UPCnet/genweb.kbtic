...
class INavigationPortletFolder(IPortletDataProvider):
...
class Assignment(base.Assignment):
    implements(INavigationPortletFolder)
...
class AddForm(base.AddForm):
    form_fields = form.Fields(INavigationPortletFolder)
...
class QueryBuilder(object):
    ...
    adapts(Interface, INavigationPortletFolder)
